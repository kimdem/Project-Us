            ...
            <div className="toolbar-buttons">
                ...
                {tool === "insert" && (
                    <>
                        ...
                        <button onMouseDown={e=>e.preventDefault()} onClick={() =>editor.chain().focus().addRowBefore()}>위쪽 행 추가</button>
                        <button onMouseDown={e=>e.preventDefault()} onClick={() => editor.chain().focus().addRowAfter()}>아래쪽 행 추가</button>
                        <button onMouseDown={e=>e.preventDefault()} onClick={() =>editor.chain().focus().addColumnAfter()}>오른쪽 열 추가</button>
                        <button onMouseDown={e=>e.preventDefault()} onClick={() =>editor.chain().focus().addColumnBefore()}>왼쪽 열 추가</button>
                        <button onMouseDown={e=>e.preventDefault()} onClick={() =>editor.chain().focus().deleteRow()}>행 삭제</button>
                        <button onMouseDown={e=>e.preventDefault()} onClick={() =>editor.chain().focus().deleteColumn()}>열 삭제</button>
                        <button onMouseDown={e=>e.preventDefault()} onClick={() =>editor.chain().focus().deleteTable()}>테이블 삭제</button>
                    </>
                )}
                {tool === "special" && (
                    <>
